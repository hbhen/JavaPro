...
<html>
    ...
    <title>狼族工作室-找回密码第二步</title>    </head>
        ...
        <table width="765" border="0" align="center" cellpadding="0" cellspacing="0" background="images/re_center.jpg">
         ...
         <table width="367" border="0">
                  <tr>
                    ...
                    <td width="163" colspan="2"><input name="result" type="text"><input name="account" type="hidden" value="${requestScope.userInfo.account}"></td>
                  </tr>
                  <tr>
                    <td height="25">&nbsp;</td>
